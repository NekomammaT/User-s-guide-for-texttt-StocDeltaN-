...
The next step value of each site is determined by the nearest sites so that they locally satisfy the discretized PDE, and then all site values are updated simultaneously. To describe this method in detail, let us reillustrate the lattice box in Fig.~\ref{fig: lattice}.
